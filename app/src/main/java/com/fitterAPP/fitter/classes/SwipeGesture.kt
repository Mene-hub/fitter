...
class SwipeGesture{
     ...
     * @since 27/07/2022
     */
    abstract  class SwipeGestureLeft(private val context : Context) : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN or ItemTouchHelper.START or  ItemTouchHelper.END, ItemTouchHelper.LEFT) {
